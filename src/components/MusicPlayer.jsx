...
export default function MusicPlayer({ currentSong, audioRef }) {
    ...
    return (
        <footer className=" flex flex-col justify-center fixed bottom-0 left-0 right-0 z-50 border-t border-zinc-800 bg-zinc-950 px-3 py-3 sm:px-6 sm:py-4">
            ...
            <div className="mx-auto flex max-w-7xl flex-col gap-4 px-3 py-3 sm:flex-row sm:items-center sm:justify-between">


                <div className="flex w-full min-w-0 items-center gap-3 sm:w-1/4">
                    <img
                    ...
                    <button className="shrink-0 text-zinc-400 hover:text-red-500">
                ...
                <div className="flex w-full flex-1 flex-col items-center sm:w-2/4">
                    ...
                    <div className="mb-2 flex items-center justify-center gap-6">
                        ...
                        <button
                            className="rounded-full bg-white p-3 text-black hover:scale-105"
                            onClick={togglePlay}
                        >
                            {isPlaying ? (
                ...
                <div className="hidden w-1/4 items-center justify-end gap-3 sm:flex">
